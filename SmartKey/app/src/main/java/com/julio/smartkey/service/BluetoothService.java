package com.julio.smartkey.service;
...
public class BluetoothService extends Service {
    ...
    private static final String NAME_INSECURE = "BluetoothSerialServiceInSecure";
    ...
    // Well known SPP UUID
    private static final UUID UUID_SPP = UUID.fromString("7517e58b-565e-402a-9c02-d91cdb50d978");
    ...
    public BluetoothService() {
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                // Xu ly goi ham callback o day.
                Log.i("TULV2", msg.toString());
                switch (msg.what) {
                    ...
                    case MESSAGE_TOAST:
                        if (connectListener != null) {
                            connectListener.onToastMessage(msg.getData().get(TOAST).toString());
                        }
                        break;
                    case MESSAGE_READ_RAW:
                        if (connectListener != null) {
                            byte[] rawData = (byte[]) msg.obj;
                            connectListener.readRawData(rawData);
                        }
                        break;
                    default:
                        break;
